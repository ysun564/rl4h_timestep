...
2. /local/scratch/ysun564/anaconda3/envs/rl4h_rep_new/bin/python
/local/scratch/ysun564/project/OfflineRL_TimeStep/RL_mimic_sepsis/d_BCQ/src/opt8.py
"""
...
if knn_pib:
    ...
    from model_old8 import timestep, action_space, num_actions, state_dim, horizon
    from model_old8 import BCQ
