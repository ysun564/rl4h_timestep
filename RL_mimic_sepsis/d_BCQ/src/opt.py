...
/local/scratch/ysun564/project/OfflineRL_TimeStep/RL_mimic_sepsis/d_BCQ/src/opt.py
"""
...
if knn_pib:
    ...
    from model_old import timestep, action_space, num_actions, state_dim, horizon
