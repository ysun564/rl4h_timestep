...
parser.add_argument("-p", "--password", default='200254', help="User's password for MIMIC Database", type=str)
...
exportdir = os.path.join(os.getcwd(),'./data/process/processed_files_20250517_2')
